...
(function() {
    ...
    const Components = {
        ...
        header: (options = {}) => {
            ...
            return `
            <header id="header" class="fixed top-0 left-0 right-0 z-50 bg-white header-transition">
                <div class="max-w-container mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
                    <div class="flex items-center justify-between py-4 md:py-6">
                        ...
                        <a href="https://www.youtube.com/@OnTheDocket-SCOTUS" target="_blank" rel="noopener noreferrer"
                           class="inline-flex items-center justify-center px-4 py-2 md:px-6 md:py-2.5 bg-primary text-white text-xs sm:text-sm font-normal rounded-md hover:bg-primary-hover transition-colors whitespace-nowrap">
                            Watch on YouTube
                        </a>
                    </div>
                </div>
